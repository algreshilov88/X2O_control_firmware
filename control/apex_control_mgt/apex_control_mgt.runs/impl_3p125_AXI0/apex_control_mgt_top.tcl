...
namespace eval ::optrace {
  variable script "/home/greshilov/vivado/JTAG_DMA/control/apex_control_mgt/apex_control_mgt.runs/impl_3p125_AXI0/apex_control_mgt_top.tcl"
...
proc step_failed { step } {
  ...
  set ch [open $endFile w]
  close $ch
OPTRACE "impl_3p125_AXI0" END { }
}

set_msg_config -id {HDL-1065} -limit 10000

OPTRACE "impl_3p125_AXI0" START { ROLLUP_1 }
...
set rc [catch {
  ...
  open_checkpoint apex_control_mgt_top_postroute_physopt.dcp
...
set_property TOP apex_control_mgt_top [current_fileset]
OPTRACE "read constraints: write_bitstream" START { }
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  catch { write_mem_info -force -no_partial_mmi apex_control_mgt_top.mmi }
  catch { write_bmm -force apex_control_mgt_top_bd.bmm }
